...
begin
//  FormcadastroEstado := TFormcadastroEstado.Create(Self);     //Criando formulário em tempo de execução
//  try
//  FormCadastroEstado.ShowModal;   //Executando formulário com "ShowModal" para encerrar o processo e não continuar o Try
//  finally
//    FreeAndNil(FormCadastroEstado);  // Liebrando a variável da memória
//  end;
